...
class Trainer_bn(object):
            ...
            for epoch in range(epochs):
                ...
                for step in range((epoch*training_iters), ((epoch+1)*training_iters)):
                    ...
                    if step % display_step == 0:
                        logging.info("Iter {:} (before training on the batch) Minibatch loss= {:.4f}, Minibatch abs err= {:.4f}".format(step, loss, avg_psnr))
    ...
    def output_minibatch_stats(self, sess, summary_writer, step, batch_x, batch_y):
        ...
        logging.info("Iter {:} (After training on the batch) Minibatch Loss= {:.4f}, Minibatch Abs Err= {:.4f}".format(step,loss,avg_psnr))
